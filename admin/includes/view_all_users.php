<table class="table table-border table-hover">
      ...
      <?php
          ...
          while ($row = mysqli_fetch_assoc($select_users)) {
              ...
              echo "
                  <th><a href='users.php?change_to_admin=$user_id'>Admin</a></th>
                  <th><a href='users.php?change_to_subscriber=$user_id'>Subscriber</a></th>
                  <th><a href='users.php?source=edit_user&p_id=$user_id'>Edit</a></th>
                  <th><a href='users.php?delete=$user_id'>Delete</a></th>
              </tr>
              ";
          };
